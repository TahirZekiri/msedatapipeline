...
export default function Home() {
    ...
    const fetchMarketData = async (timeframe: string) => {
        try {
            const response = await fetch(
                `${API_BASE_URL}/stockData/most-traded-stock?timeframe=${encodeURIComponent(timeframe)}`
            );
    ...
    const fetchTopGainers = useCallback(
        async (timeframe: string) => {
            try {
                const response = await fetch(
                    `${API_BASE_URL}/stockData/top-gainers?timeframe=${encodeURIComponent(timeframe)}`
                );
    ...
    const fetchMarketCapitalizationData = async (timeframe: string) => {
        try {
            const response = await fetch(
                `${API_BASE_URL}/stockData/marketCapData?timeframe=${encodeURIComponent(timeframe)}`
            );
            const data = await response.json();
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`${API_BASE_URL}/stockData/top-gainers-losers`);
                const data = await response.json();
